...
<nav class="navbar navbar-toggleable-md navbar-bg-primary" id="mynav" >
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container">
            <div class="col-md-2 col-sm-2" id="fonline" style="height:85vh">
            ...
            <div class="col-md-6 col-sm-4" id="posts" style="height:90vh">
	...
	endwhile;?>
            ...
            <div class="col-md-4 col-sm-2" id="notifychat" style="position:fixed; right:0; top:0; margin:0px; height:92%; margin-top:4%">
